    ...
    <section className="space-y-6">
      ...
      <div className="image1-card p-6 sm:p-9 relative overflow-hidden">
        ...
        <div className="flex justify-end pt-2">
          ...
          >
            <span>{isUnlocked ? '已解鎖專屬物資' : '物資解鎖'}</span>
      ...
      <div className="image1-card p-6 sm:p-8 space-y-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base sm:text-lg font-black text-[#111827]">
              實戰聲明 // ANTI-INFLAMMATORY MANIFESTO
            </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
          <div className="p-3 rounded-xl bg-[#F8FAFC] border-2 border-[#111827] shadow-[2px_2px_0px_#111827]">
            ...
            <div className="text-xs font-black text-[#111827] mt-0.5">免費體驗區</div>
            <div className="text-[11px] text-slate-600 mt-1">21日抗炎、7件事指南、咖啡多酚全開放</div>
          </div>
          <div className="p-3 rounded-xl bg-[#F8FAFC] border-2 border-[#111827] shadow-[2px_2px_0px_#111827]">
            <div className="text-[10px] font-black text-[#D97706] uppercase">STEP 02</div>
            <div className="text-xs font-black text-[#111827] mt-0.5">Passkey 驗證</div>
            <div className="text-[11px] text-slate-600 mt-1">輸入體驗碼或專屬代碼一秒即時解密</div>
          </div>
          <div className="p-3 rounded-xl bg-[#F8FAFC] border-2 border-[#111827] shadow-[2px_2px_0px_#111827]">
            <div className="text-[10px] font-black text-[#16A34A] uppercase">STEP 03</div>
            <div className="text-xs font-black text-[#111827] mt-0.5">解鎖專屬物資</div>
            <div className="text-[11px] text-slate-600 mt-1">護胃、益生元、發酵菜、草飼牛直達物資</div>
          </div>
        </div>
      </div>
    </section>
